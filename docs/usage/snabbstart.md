...
3. Ange åtkomstnycklarna (_Consumer Key_ respektive _Consumer Secret_) du fått från Lantmäteriets API-manager ([instruktioner](installningar/atkomstnycklar.md))
